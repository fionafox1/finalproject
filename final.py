...
for n in rural_arts_unpop:
    print(n['name'])


tree = ('Would you like to visit somewhere urban or rural? Type yes for urban and no for rural',
('Would you like to experience the arts or the outdoors? Type yes for arts and no for outdoor', ('Would you like popular or unpopular? Type yes for popular and no for unpopular', (detroit_arts_pop[0]['name'], None, None), (detroit_arts_unpop[2]['name'], None, None)),
...
('Would you like to experience the arts or the outdoors? Type yes for arts and no for outdoor', ('Would you like popular or unpopular? Type yes for popular and no for unpopular', (rural_arts_pop[0]['name'], None, None), (rural_arts_unpop[1]['name'], None, None)),
