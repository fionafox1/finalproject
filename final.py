...
#url_text = make_url_request_using_cache(search_api_url, params, CACHE_DICT)
#print(type(url_text))
#import scrapy
...
class Spider(scrapy.Spider):
    name = "Arts"
    start_urls = [
        'https://visitdetroit.com/must-see-masterpieces-at-the-detroit-institute-of-arts-in-2022/'
    ]

    def parse(self, response):
        for quote in response.css('div.left'):
            yield {
                'text': quote.css('content-editor::before').get()
            }
'''

tree = ('Would you like to visit somewhere urban or rural? Type yes for urban and no for rural',
('Would you like arts or outdoor? Type yes for arts and no for outdoor', ('Would you like popular or unpopular? Type yes for popular and no for unpopular', (detroit_arts_pop[0]['name'], None, None), (detroit_arts_unpop[2]['name'], None, None)),
('Would you like popular or unpopular? Type yes for popular and no for unpopular', (detroit_active_pop[0], None, None), (detroit_active_unpop[0]['name'], None, None))),
('Would you like arts or outdoor? Type yes for arts and no for outdoor', ('Would you like popular or unpopular? Type yes for popular and no for unpopular', (rural_arts_pop[0]['name'], None, None), (rural_arts_unpop[1]['name'], None, None)),
('Would you like popular or unpopular? Type yes for popular and no for unpopular?', (rural_active_pop[0]['name'], None, None), (rural_active_unpop[4]['name'], None, None))))
